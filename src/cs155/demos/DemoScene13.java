...
public class DemoScene13 {
	...
	private static void initScene(AnimatedScene3D scene){
		...
		Material mat6 = new Material(new Color3D(0d,0d,0d), new Color3D(0d,0d,0d), new Color3D(0d,0d,1d), new Color3D(1d,1d,0d),200);
		...
		tex4.scale(50,50);
		mat4.texture = tex4;
		mat4.texWeight = 0.95; //75;

		ImageTexture tex6 = new ImageTexture("images/earth.png");
		tex6.scale(50,50);
		mat6.texture = tex6;
		mat6.texWeight = 0.95; //75;
		
		ImageTexture tex5 = new ImageTexture("images/grass.png");
		tex5.scale(50,50);
		mat5.texture = tex5;
		mat5.texWeight = 0.95;
...
//		Cylinder3D cyl1 = new Cylinder3D(new Point3D(1,-1,-15),new Point3D(0,1,0),3.0,15.0,mat4);
		...
		Sphere3D sp1 = new Sphere3D(new Point3D(10,5,-200),20.0,mat6);
		Sphere3D sp2 = new Sphere3D(new Point3D(0,5,-20),20.0,mat4);
...
//		Light3D light4 = new Light3D(new Point3D(-2,13,-4),1.0); // this light is inside cylinder 1, toward the far end
		...
		cyl2.insideMat = mat1; // here we change the material on the inside of cylinder 2
    		...
    		GifCanvas3D mc = new GifCanvas3D("DemoScene13", 800, 800);
...
//		scene.add(light4);
        ...
        scene.anim = new Animator3D() {    //Implemented Animator3D methods, which allows for animations.
            ...
            public Scene3D next() {
                int x = count;
                int y = -(x-h)^2 + k;
		sp2.applyTrans(sp2.transform.translate(x,0,0));
		sp1.applyTrans(sp1.transform.translate(0,0,x));
                count++;
                return scene;
            }
        };
